    ...
    return (
      <div>
        <div className="mySlides">
          <div className="text">MyHelp</div>
        </div>


        <div className="goEvents">
          <h2>MyHelp transforms volunteer recruiting, making it quick, <br /> easy and effective.</h2>
        ...
        <div className="aboutUs">
          <p>MyHelp is the most effective way to recruit highly qualified volunteers for your nonprofit. We match you with people who are passionate about and committed to your cause, and who can help when and where you need them.
          <br />
          <br />
        ...
        <footer>
          <p>Posted by: MyHelp</p>
          <p>&copy; MyHelp, 2018</p>
        </footer>
